...
public class EarthArtifactItem extends Item {
    public EarthArtifactItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        boolean success = ArtifactSwitcher.setWandArtifact(user, Artifacts.EARTH);
